...
with sync_playwright() as p:
    ...
    check('S134b: Align grey while max width is 0 (Characterart tab rule)', agreyed('LogoArtMovieCharacterartAlignRow') is True)
    apage.evaluate("() => { var e = document.getElementById('LogoArtMovieCharacterartMaxWidthVw'); e.value = '20'; e.dispatchEvent(new Event('input', { bubbles: true })); e.dispatchEvent(new Event('change', { bubbles: true })); }")
    check('S134b: Align active once max width > 0', agreyed('LogoArtMovieCharacterartAlignRow') is False)
